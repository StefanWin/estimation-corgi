/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 4b2cc764c18d356bc4fd44b06716908f)
// Runtime types generated with workerd@1.20250712.0 2025-04-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_PUBLIC_TURNSTILE_SITE_KEY: "0x4AAAAAABm9bcFjEcRLc5uh";
		ON_SUGGEST_EMAIL: "wintergerst.stefan@googlemail.com";
		DB: D1Database;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_TURNSTILE_SITE_KEY" | "ON_SUGGEST_EMAIL">> {}
}
