	...
	return (
		<>
			...
			<Link
				...
				rel="noopener noreferrer"
			>
				Image Attribution: Cute Corgi Dog, Friendly Companion, Fluffy Tail,
				Playful Pet, Loyal Breed PNG
			</Link>
			<NextImage
				src={blepCorgi}
				style={{ objectFit: 'contain' }}
			...
			<Link
				...
				rel="noopener noreferrer"
			>
				Image Attribution: Cute Corgi Dog, Joyful Pet, Friendly Breed, Fluffy
				Companion, Charming Pup PNG
			</Link>
		</>
	);
}
